...
class PreAssessmentController extends AdminController
{
    ...
    protected function form()
    {
        ...
        $form->select('contract_id', __('valuation_document.contract_id'))->options(Contract::where("branch_id", Admin::user()->branch_id)->where('status', Constant::CONTRACT_INPUTTING_STATUS)
